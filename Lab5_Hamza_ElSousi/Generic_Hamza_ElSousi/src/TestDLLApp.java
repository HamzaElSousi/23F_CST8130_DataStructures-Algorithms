...
/**
 * This class tests the functionality of the DoublyLinkedList class.
 */
public class TestDLLApp {
    /**
     * Main method to test the DoublyLinkedList functionality.
     *
     * @param args the command line arguments.
     */
    public static void main(String[] args) {
        DoublyLinkedList<Integer> newLL = new DoublyLinkedList<>();
        ...
        DoublyLinkedList<Integer>.Node<Integer> deletedNode = newLL.searchAndDelete(9);
